...
class Auth extends CI_Controller {
    ...
    public function registrationPt()
    {
        if ($this->session->userdata('email')) {
            redirect('user');
        }
        ...
        if ($this->form_validation->run()==false) {
            ...
            $this->load->view('template/auth_header', $data);
            $this->load->view('auth/registration-pt');
            $this->load->view('template/auth_footer');
        } else {
            $email = $this->input->post('email', true);
            $data = [
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'bimbimbimcotabimcotabim@gmail.com',
            'smtp_pass' => 'tpqaxkposfjeeebg',
            'smtp_port' => 465, 
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        // Load email library dan inisialisasi config
        ...
        $this->email->from('bimbimbimcotabimcotabim@gmail.com', 'Surya');
        ...
        if($type == 'verify') {
            ...
            $this->email->subject('Reset Paswwordd');
